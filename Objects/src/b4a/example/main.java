...
RDebugUtils.currentLine=2424832;
 //BA.debugLineNum = 2424832;BA.debugLine="Sub enkripsi";
RDebugUtils.currentLine=2424833;
 //BA.debugLineNum = 2424833;BA.debugLine="passwordhash = md.GetMessageDigest(p.GetBytes(\"UT";
_passwordhash = mostCurrent._md.GetMessageDigest(mostCurrent._p.getBytes("UTF8"),"MD5");
RDebugUtils.currentLine=2424834;
 //BA.debugLineNum = 2424834;BA.debugLine="epass = ByteCon.HexFromBytes(passwordhash)";
...
RDebugUtils.currentLine=1441792;
 //BA.debugLineNum = 1441792;BA.debugLine="Private Sub Masuk_Click";
RDebugUtils.currentLine=1441794;
 //BA.debugLineNum = 1441794;BA.debugLine="If NamaPengguna.Text =  \"\" Then";
if ((mostCurrent._namapengguna.getText()).equals("")) { 
RDebugUtils.currentLine=1441795;
 //BA.debugLineNum = 1441795;BA.debugLine="MsgboxAsync(\"Masukan Nama Pengguna\", \"Info\")";
...
RDebugUtils.currentLine=1441799;
 //BA.debugLineNum = 1441799;BA.debugLine="If password.Text =  \"\" Then";
if ((mostCurrent._password.getText()).equals("")) { 
RDebugUtils.currentLine=1441800;
 //BA.debugLineNum = 1441800;BA.debugLine="MsgboxAsync(\"Masukan Password\", \"Info\")";
...
RDebugUtils.currentLine=1441804;
 //BA.debugLineNum = 1441804;BA.debugLine="ModulKoneksi.koneksi";
mostCurrent._modulkoneksi._koneksi /*String*/ (mostCurrent.activityBA);
RDebugUtils.currentLine=1441806;
 //BA.debugLineNum = 1441806;BA.debugLine="p = password.Text";
mostCurrent._p = mostCurrent._password.getText();
RDebugUtils.currentLine=1441808;
 //BA.debugLineNum = 1441808;BA.debugLine="enkripsi";
_enkripsi();
RDebugUtils.currentLine=1441810;
 //BA.debugLineNum = 1441810;BA.debugLine="ModulKoneksi.ResultS = ModulKoneksi.MHandler.Quer";
...
RDebugUtils.currentLine=1441811;
 //BA.debugLineNum = 1441811;BA.debugLine="If ModulKoneksi.ResultS.RowCount > 0 Then";
if (mostCurrent._modulkoneksi._results /*mysql.mysqlhandler.ResultSetWrapper*/ .RowCount()>0) { 
RDebugUtils.currentLine=1441813;
 //BA.debugLineNum = 1441813;BA.debugLine="ModulKoneksi.ResultS = ModulKoneksi.MHandler.Que";
mostCurrent._modulkoneksi._results /*mysql.mysqlhandler.ResultSetWrapper*/  = (mysql.mysqlhandler.ResultSetWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new mysql.mysqlhandler.ResultSetWrapper(), (java.sql.ResultSet)(mostCurrent._modulkoneksi._mhandler /*mysql.mysqlhandler*/ .Query("SELECT * FROM tb_akunwarga WHERE username='"+mostCurrent._namapengguna.getText()+"' and password ='"+mostCurrent._epass+"'")));
RDebugUtils.currentLine=1441814;
 //BA.debugLineNum = 1441814;BA.debugLine="If ModulKoneksi.ResultS.RowCount > 0 Then";
if (mostCurrent._modulkoneksi._results /*mysql.mysqlhandler.ResultSetWrapper*/ .RowCount()>0) { 
RDebugUtils.currentLine=1441817;
 //BA.debugLineNum = 1441817;BA.debugLine="ModulKoneksi.MHandler.Close";
mostCurrent._modulkoneksi._mhandler /*mysql.mysqlhandler*/ .Close();
RDebugUtils.currentLine=1441819;
 //BA.debugLineNum = 1441819;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
RDebugUtils.currentLine=1441820;
 //BA.debugLineNum = 1441820;BA.debugLine="StartActivity(Profile)";
...
RDebugUtils.currentLine=1441823;
 //BA.debugLineNum = 1441823;BA.debugLine="MsgboxAsync(\"Password Tidak Ditemukan\", \"Info\")";
...
RDebugUtils.currentLine=1441824;
 //BA.debugLineNum = 1441824;BA.debugLine="password.Text = \"\"";
mostCurrent._password.setText(BA.ObjectToCharSequence(""));
RDebugUtils.currentLine=1441825;
 //BA.debugLineNum = 1441825;BA.debugLine="Return";
if (true) return "";
 };
 }else {
RDebugUtils.currentLine=1441829;
 //BA.debugLineNum = 1441829;BA.debugLine="MsgboxAsync(\"Nama Pengguna Tidak Ditemukan\",\"Inf";
...
RDebugUtils.currentLine=1441830;
 //BA.debugLineNum = 1441830;BA.debugLine="NamaPengguna.Text = \"\"";
mostCurrent._namapengguna.setText(BA.ObjectToCharSequence(""));
RDebugUtils.currentLine=1441831;
 //BA.debugLineNum = 1441831;BA.debugLine="Return";
if (true) return "";
 };
